...
public record GetCustomerByParametersQuery(long? CustomerNumber,string FirstName,string LastName,string IdentityNumber) : IRequest<ApiResponse<List<CustomerResponse>>>;